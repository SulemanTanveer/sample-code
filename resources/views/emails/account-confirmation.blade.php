...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto; padding-top:40px; width:600px;" align="center" >
    ...
    <tr>
        <td style="padding-top:54px;" >
          <p style="	color: #0647c9;	font-size: 18px;	font-weight: 600;	line-height: 32px;">Bonjour {{$user->profile->firstname}},</p>
          <p>Toute l’équipe de Rentrée Zen vous souhaite la bienvenue et vous remercie pour votre inscription!</p>
          <p>Pour vous rendre sur Rentrée Zen, <a href="https://rentree-zen.fr/" target="_blank">cliquez ici</a></p>
          <p>Voici votre CODE PROMOTIONNEL DE 10% à valoir sur www.rentree-zen.fr</p>

      </td>
    </tr>
    <tr>
        <td align="center">
            <table text-align="center" style="text-align:center;padding-top:20px;">
                <tr>
                    <td class="white" style="height: 40px;	width: 262px; font-size:24px;	border: 1px solid #FFFFFF; color:#FFFFFF;	border-radius: 2px;	background-color: #0647c9;">
                        RZL56875
                    </td>
                </tr>
            </table>
