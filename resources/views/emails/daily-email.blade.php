...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto; padding-top:40px; width:600px;" align="center" >
    ...
    <tr>
        <td style="padding-top:54px;" >
          <p style="	color: #0647c9;	font-size: 18px;	font-weight: 600;	line-height: 32px;">Bonjour,</p>
          <p>Ci-joint les commandes du jour pour Rentrée Zen.</p>
        </td>
    </tr>
   <tr>
        <td style="padding-top:54px;" >
          <p>Vous trouverez ci-dessous les factures (PDF) des commandes du jour sur Rentrée Zen. </p>
       @foreach ($invoice_refs as $reference)
               <p>
                   <a href="{{env('BACKEND_URL')}}/api/v1/order/invoice/{{$reference}}">{{$reference}}</a>
               </p>
           @endforeach</td>
    </tr>
