...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto; padding-top:40px; width:600px;" align="center" >
    ...
    <tr>
        <td style="padding-top:54px;" >
          ...
          <p>Vous venez d'effectuer une commande sur Rentrée ZEN et nous vous en remercions.</p>
          <p>Vous trouverez ci-dessous le récapitulatif de cet achat ainsi que les détails de votre paiement :</p>
          <br />
          <p><b>Numéro de commande : <a href="{{env('FRONT_END_URL')}}order/{{$order->reference}}">{{$order->reference}}</a> </b></p>
          ...
          <p>Date de livraison estimée : {{$order->delivery_date }}</p>
          <br />
          <p>Modalités de retour :<br />
          Vous disposez d'un délai légal de 14 jours à compter de la date de réception de votre commande pour nous signaler
          votre intention de nous retourner un ou plusieurs articles.
          Pour cela, il vous suffira de vous rendre dans notre rubrique «<a href="https://rentree-zen.fr/cgv/" target="_blank">Conditions Générales de Vente».</a></p>
          <br />
