...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto; padding-top:40px; width:600px;" align="center" >
    ...
    <tr>
        <td style="padding-top:54px;" >
          ...
          <p>Une demande de réinitialisation de votre mot de passe nous est parvenue. Vous pouvez réinitialiser votre mot de passe en cliquant sur le lien suivant :</p>

        </td>
    </tr>
    <tr class="text-center">
        <td>
            <a href="{{env('FRONT_END_URL').('reset-password/'.$user->generateHash().'/'.$user->email)}}">
